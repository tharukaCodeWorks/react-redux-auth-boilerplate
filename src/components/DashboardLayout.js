  ...
  return (
    <div className={classes.root}>
      ...
      >
        ...
        <Divider />
        <List>
            <ListItem button onClick={()=>handleOnNavClick('/home')}>
              <ListItemIcon><DashboardIcon></DashboardIcon></ListItemIcon>
              <ListItemText primary="Dashboard" />
            </ListItem>

            <ListItem button onClick={()=>handleOnNavClick('/dashboard/item-types')}>
              <ListItemIcon><ListIcon></ListIcon></ListItemIcon>
              <ListItemText primary="Item Types" />
            </ListItem>

            <ListItem button onClick={()=>handleOnNavClick('/dashboard/items')}>
              <ListItemIcon><ListIcon></ListIcon></ListItemIcon>
